...
(function() {
  ...
  Model = (function() {
    ...
    Model.constructor = function(obj) {
      var attr, func, val, _i, _j, _len, _len1, _ref, _ref1;
      obj._dirty = [];
      _ref = this._attrs;
    ...
    Model.validate = function(obj, id) {
      var attr, attrs_obj, dct, func, klass, ok_for_requireds, path, path_, req, requireds, v, val, value, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2;
          ...
          if (__indexOf.call(klass._attrs, v) >= 0) {
            ...
            if (!ok_for_requireds) {
              ...
              for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
                attr = _ref2[_k];
                if (__indexOf.call(klass[attr], required) >= 0) {
                  requireds.push(attr);
                }
              }
