...
(function() {
  var make_autocomplete, make_form, make_form_events, _dirty, _disabled, _invisible, _make_autorun, _obj_from_path, _on_change, _on_change_bool, _on_change_generic,
  ...
  _make_autorun = function(form_name, klass, parent, path_) {
    return function() {
      var id, initial, initials, obj, path, x, _ref;
      if (parent !== null) {
        ...
        if (typeof x === 'string') {
          ...
          _ref = ['', x], id = _ref[0], initial = _ref[1];
        }
        path = [];
      }
  ...
  _invisible = function(parent) {
    return function() {
      if (Session.get(parent + '_object_id') === '' || _.isObject(Session.get(parent + '_object_id'))) {
        return "invisible";
      } else {
        return "";
      }
