...
(function() {
  ...
  Model = (function() {
    ...
    Model.save = function(obj, form_name) {
      var dct, dct_aux, last, lista, na, name, path, pos, _i, _id_, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4;
      if (obj._path.length === 0) {
        ...
        if (pos !== null && (pos === -1 || pos >= lista.length)) {
          ...
          return Session.set(form_name + '_object_id', lista.length.toString());
        } else {
          path = obj._path.join('.');
          dct_aux = {};
          _ref4 = obj._dirty;
