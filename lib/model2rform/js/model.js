...
(function() {
  ...
  Model = (function() {
    ...
    Model.setInvalid = function(obj) {
      obj._valid = false;
      return obj._dirty.push('_valid');
    };

    Model.findOne = function(dct) {
      var obj;
      obj = this._collection.findOne(dct);
    ...
    Model.save = function(obj, form_name) {
      var dct, dct_aux, last, lista, na, name, path, pos, v, _i, _id_, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
      if (obj._path.length === 0) {
        ...
        if (/^\d+$/.test(last) || last === '-1') {
          pos = parseInt(last);
          path = obj._path.slice(0, -1).join('.');
          dct = {};
          dct[path] = 1;
          lista = this._collection.findOne({
            _id: obj._id
          }, dct);
          _ref2 = path.split('.');
          for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
        ...
        if (pos !== null && (pos === -1 || pos >= lista.length)) {
          path = obj._path.slice(0, -1).join('.');
          dct_aux = {};
          _ref3 = obj._dirty;
          ...
          return Session.set(form_name + '_object_id', obj._path.slice(0, -1).join(".") + '.' + lista.length.toString());
        } else {
          path = obj._path.join('.');
          dct_aux = {};
          _ref5 = obj._dirty;
