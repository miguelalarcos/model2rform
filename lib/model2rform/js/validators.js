...
(function() {
  var boolean, date, datetime, email, float, integer, max, min, nested, nested_array, references, references_, required, smax, smin, string, string_array, string_select, text,
