...
(function() {
  var boolean, date, datetime, email, float, integer, max, min, nested, nested_array, references, references_, required, smax, smin, string, string_array, string_select, text, today,
  ...
  references_ = function(list, attr, x) {
    return function() {
      var dct, obj;
      dct = {};
      dct[attr] = x;
