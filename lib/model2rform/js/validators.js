...
(function() {
  var boolean, date, datetime, email, float, integer, max, min, nested, nested_array, reference_from_value, references, required, smax, smin, string, string_array, string_select, text, today,
